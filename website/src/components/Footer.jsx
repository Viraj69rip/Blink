      ...
      <div className="container">
        ...
        >
          ...
          <p style={{ fontSize: 15, color: 'var(--color-text-secondary)', marginBottom: 32, lineHeight: 1.7 }}>
            BLINK is fully open source. Fork the hardware, hack the firmware, and make it your own.
          </p>
          ...
          <p style={{ marginTop: 48, fontSize: 12, color: 'var(--color-text-tertiary)' }}>
            &copy; {year} BLINK Project. Made with &hearts; and open source.
          </p>
        </motion.div>
      </div>
    </footer>
